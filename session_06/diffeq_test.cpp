...
main (void)
{
  ...
  ofstream out ("diffeq_test_2nd_h.dat");	// open the output file 
  ...
  double h = 0.01;		// initialize mesh spacing (change to 2nd h value of 0.1/10
  ...
  cout << "data stored in diffeq_test_2nd_h.dat\n";
